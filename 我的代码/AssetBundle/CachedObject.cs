        ...
        public bool Recycle(UObject _object)
        {
            ...
            if (rt == ResourceType.Multi)
            {
                ...
                if (activeCopies.Contains(_object))
                {
                    ...
                    if ((AssetBundleConfig.Instance.UseAssetBundle && this.parent == null) || (this.parent != null && this.parent.bundleInfo.releaseMode == ReleaseMode.Immediate)|| AssetBundleConfig.Instance.ReleaseImmediate)
                        Release();
                    return true;
                }
            }
