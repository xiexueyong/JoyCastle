...
namespace Framework.Asset
{
    ...
    public class CachedAssetBundleContainer:IdleClass
    {
        ...
        {
            AssetBundleInfo abInfo = AssetBundleManager.Instance.GetAssetBundleInfo(assetBundleName);
            LoadBundle(abInfo);
        }
        ...
        private bool IsDepended(string bundleName)
        {
            ...
            {
                if (bundleName != key &&
                    AssetBundleManager.Instance.GetAssetBundleInfo(key).DependenciesBundleNames.Contains(bundleName))
                {
                    return true;
                }
            }
